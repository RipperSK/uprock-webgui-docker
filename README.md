# uprock-webgui-docker
This is essentially only a Dockerfile that updates https://hub.docker.com/r/oneptp/uprock-webgui/ with new version

# obtaining newer version steps:
